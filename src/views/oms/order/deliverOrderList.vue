...
<script>
import { deliveryOrder, fetchShippingInfo } from "@/api/order";
...
export default {
  ...
  created() {
    ...
    this.getShippingInfo(this.$route.query.orderDetailId);
  },
  methods: {
    getShippingInfo(orderDetailId) {
      this.listLoading = true;
      let params = new URLSearchParams();
      this.list = [];
      params.append("orderId", orderDetailId);
      fetchShippingInfo(params).then((response) => {
