    ...
    <div class="table-container">
      ...
      >
        ...
        <el-table-column label="编号" width="80" align="center">
          <template slot-scope="scope">{{ scope.row.orderDetailId }}</template>
        </el-table-column>
        ...
        <el-table-column label="支付方式" width="120" align="center">
          <template slot-scope="scope">{{
            scope.row.paymentMethod | formatPayType
          }}</template>
        </el-table-column>
        ...
        <el-table-column label="操作" width="200" align="center">
          <template slot-scope="scope">
            ...
            <el-button
              ...
              v-show="scope.row.orderStatus === 2 || scope.row.status === 3"
              >订单跟踪</el-button
            >
            <!-- <el-button
              size="mini"
  ...
  methods: {
    ...
    handleViewOrder(index, row) {
      this.$router.push({
        ...
        query: { orderDetailId: row.orderDetailId },
      });
    },
