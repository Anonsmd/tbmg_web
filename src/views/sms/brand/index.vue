      ...
      >
        ...
        <el-table-column label="品牌图片" width="120" align="center">
          <template slot-scope="scope"
            ><img style="height: 80px" :src="scope.row.brandLogo"
          /></template>
        </el-table-column>
        ...
        <el-table-column label="排序" width="160" align="center">
          <template slot-scope="scope">{{ scope.row.brandOrder }}</template>
        </el-table-column>
...
export default {
  ...
  methods: {
    ...
    handleEditSort(index, row) {
      ...
      this.sortDialogData.sort = row.brandOrder;
    ...
    handleUpdateSort() {
      this.$confirm("是否要修改排序?", "提示", {
        ...
        setOrder(this.sortDialogData.id, this.sortDialogData.sort).then(
          (response) => {
