    ...
    <div class="table-container">
      ...
      >
        ...
        <el-table-column label="编号" width="120" align="center">
          <template slot-scope="scope">{{ scope.row.newRecommendId }}</template>
        </el-table-column>
        ...
        <el-table-column label="排序" width="160" align="center">
          <template slot-scope="scope">{{ scope.row.recommendOrder }}</template>
        </el-table-column>
...
export default {
  ...
  methods: {
    ...
    handleRecommendStatusStatusChange(index, row) {
      this.updateRecommendStatusStatus(row.newRecommendId, row.recommendStatus);
    },
    ...
    handleEditSort(index, row) {
      ...
      this.sortDialogData.sort = row.recommendOrder;
      this.sortDialogData.id = row.newRecommendId;
    },
    handleUpdateSort() {
      this.$confirm("是否要修改排序?", "提示", {
        ...
        updateNewProductSort(
          this.sortDialogData.id,
          this.sortDialogData.sort
        ).then((response) => {
