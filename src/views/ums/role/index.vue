    ...
    <div class="table-container">
      ...
      >
        <el-table-column label="编号" width="100" align="center">
          <template slot-scope="scope">{{ scope.row.managerInfId }}</template>
        </el-table-column>
        ...
        <el-table-column label="邮箱" align="center">
          <template slot-scope="scope">{{ scope.row.managerEmail }}</template>
        </el-table-column>
...
<script>
import { fetchList, updateStatus } from "@/api/login.js";
  ...
  methods: {
    ...
    handleStatusChange(index, row) {
      ...
      this.$confirm("是否要修改该状态?", "提示", {
        ...
        .then(() => {
          updateStatus(names).then((response) => {
            this.$message({
              type: "success",
              message: "修改成功!",
            });
